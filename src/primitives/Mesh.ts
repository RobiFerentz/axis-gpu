...
export class Mesh extends SceneNode {
  ...
  private initialize(context: GPUContext): void {
    ...
    // Create uniform buffer for scene data (model matrix + view-projection matrix)
    this.sceneUniformBuffer = new UniformBuffer(128, 'Scene Uniforms'); // 2x mat4x4 = 128 bytes
